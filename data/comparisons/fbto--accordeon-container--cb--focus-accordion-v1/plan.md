# Deep Comparison: Accordeon container ↔ Focus accordion v1

> Generated: 2026-02-23T10:47:04.584Z
...
| Field | Value |
|-------|-------|
| **Name** | Accordeon container |
| **Brand** | FBTO (`fbto`) |
| **Selector** | `div.accordion` |
| **Description** | Container for accordion items |
| **Usage count** | 631 pages |
| **Sample page** | [https://www.fbto.nl/aanhangwagenverzekering](https://www.fbto.nl/aanhangwagenverzekering) |
| **Screenshot** | `public/screenshots/fbto/accordeon-container.png` |

<details>
<summary>Sample pages (up to 10 of 578)</summary>

- https://www.fbto.nl/aanhangwagenverzekering
- https://www.fbto.nl/aanhangwagenverzekering/schade-melden
- https://www.fbto.nl/aanhangwagenverzekering/service
- https://www.fbto.nl/autoverzekering
- https://www.fbto.nl/autoverzekering/jongeren
- https://www.fbto.nl/autoverzekering/modules
- https://www.fbto.nl/autoverzekering/modules/inzittendenverzekering
- https://www.fbto.nl/autoverzekering/modules/pechhulp-binnenland
- https://www.fbto.nl/autoverzekering/modules/pechhulp-buitenland
- https://www.fbto.nl/autoverzekering/modules/rechtsbijstand-verkeer
...
| Field | Value |
|-------|-------|
| **Name** | Focus accordion v1 |
| **Brand** | Centraal Beheer (`cb`) |
| **Selector** | `.strip.js-collapsable` |
| **Description** | — |
| **Usage count** | 196 pages |
| **Sample page** | [https://www.centraalbeheer.nl/artikelen/10-tips-proefrit-auto](https://www.centraalbeheer.nl/artikelen/10-tips-proefrit-auto) |
| **Screenshot** | `public/screenshots/cb/focus-accordion-v1.png` |

<details>
<summary>Sample pages (up to 10 of 164)</summary>

- https://www.centraalbeheer.nl/artikelen/10-tips-proefrit-auto
- https://www.centraalbeheer.nl/artikelen/10-verrassende-bespaartips
- https://www.centraalbeheer.nl/artikelen/1e-hypotheek-afsluiten
- https://www.centraalbeheer.nl/artikelen/9-tips-voor-een-gezellige-barbecueavond
- https://www.centraalbeheer.nl/artikelen/aanrijding-dier
- https://www.centraalbeheer.nl/artikelen/accu-opladen-kan-ik-dat-zelf
- https://www.centraalbeheer.nl/artikelen/alleen-op-reis-na-het-overlijden-van-uw-partner
- https://www.centraalbeheer.nl/artikelen/apk-voor-uw-autoverzekering
- https://www.centraalbeheer.nl/artikelen/auto-raar-geluid
- https://www.centraalbeheer.nl/artikelen/auto-veilig-voorjaar
...
| Dimension | FBTO | Centraal Beheer |
|-----------|------|-----------------|
| Pages affected | 631 | 196 |
| Re-authoring effort | | |
| Rollback strategy | | |
| High-traffic pages | | |
